...
export class AnimalDetailsComponent implements OnInit {
    ...
    murcirojo2 = 'https://inaturalist-open-data.s3.amazonaws.com/photos/11256353/medium.jpeg';
    murcirojo3 = 'https://inaturalist-open-data.s3.amazonaws.com/photos/146007004/medium.jpeg';
    ...
    lista: AnimalDetailModel[] = [
        ...
        {id: 'Tortuga_gigante_de_Santa_Cruz',  nombre: 'Tortuga Gigante de Santa Cruz',
            ...
            acercaDe: 'La tortuga del este de Santa Cruz, al igual que las otras 14 especies del complejo de tortugas gigantes de Galápagos, es endémica no solo del archipiélago sino del área. Estos quelonios son considerados Especies Clave e ingenieras del ecosistema. Esto se debe a que, con sus actividades y movimientos, moldean los ecosistemas, cumplen el rol de herbívoros principales, pisotean la vegetación y son los principales dispersores de semillas.[1]\n' + '\n' +
                'Se estima que alguna vez existieron alrededor de 200 000 tortugas en todo el archipiélago; en la actualidad, se considera que existe solo un 10-20% de la población original.[1] \n' + '\n' +
                'Esta dramática disminución se debe principalmente a la sobreexplotación causada por balleneros en los años 1800, seguida por una eliminación sistemática de tortugas por parte de los científicos y los primeros colonos.[1] \n' + '\n' +
                'Actualmente, se estima que la población de la tortuga del este de Santa Cruz, C. donfaustoi, tiene aproximadamente 250 adultos. Existe un programa de crianza en cautiverio establecido por la Dirección del Parque Nacional Galápagos (DPNG) desde 2015.[1]\n',
            ...
            referencias: '[1] Washington Tapia, Patricia Jaramillo y James Gibbs. “Tortuga gigante del este de Santa Cruz”. Fundación Charles Darwin (FCD) y WWF-Ecuador. (2018). Atlas de Galápagos, Ecuador: Especies Nativas e Invasoras. Quito, FCD y WWF-Ecuador: 115. \n' +
        '[2] Charles Darwin Foundation: https://www.darwinfoundation.org/en/datazone/checklist?species=17364\n' + '\n' +
            'Fotografías: Tui de Roi, recuperado de Minden Pictures.',
            urlSafe: [],
        ...
        {id: 'Pinguino_de_galapagos',  nombre: 'Pingüino de Galápagos',
            ...
            acercaDe: 'El pingüino de Galápagos es una Especie Centinela y un buen indicador de la variación climática, ya que es sensible a los fuertes cambios poblacionales asociados a los eventos de El Niño-Oscilación del Sur (ENOS) o La Niña. Durante El Niño, debido a las temperaturas altas y el alimento escaso, su población disminuye significativamente; mientras que, durante La Niña, a causa de las temperaturas bajas y el alimento abundante, la población crece y se recupera.[1]\n' + '\n' +
                'Además, el pingüino es indicador de enfermedades y patógenos que afectan a especies de aves marinas. Asimismo, ya que se alimenta de la anchoveta del Pacífico, sardinas y lisas, es una Especie Clave para distinguir los efectos negativos, como la disminución, sobre estas poblaciones de peces.[1]\n' + '\n' +
                'El pingüino de Galápagos, con una distribución restringida a zonas de afloramiento marino, y un tamaño poblacional pequeño, de entre 1 500 y 4 700 individuos, es una de las especies de ave más amenazada a nivel mundial.[1]\n',
            ...
            referencias: '[1] Gustavo Jiménez-Uzcátegui, Dee Boersma y F. Hernán Vargas. “Pingüino de Galápagos”. Fundación Charles Darwin (FCD) y WWF-Ecuador. (2018). Atlas de Galápagos, Ecuador: Especies Nativas e Invasoras. Quito, FCD y WWF-Ecuador: 119.\n' +
                '[2] Charles Darwin Foundation: https://www.darwinfoundation.org/en/datazone/checklist?species=5176\n' + '\n' + 'Fotografías: Tui de Roi, recuperado de Minden Pictures.',
            urlSafe: [],
            isMindenPictures: true,
        },
        ...
        {id: 'Lobo_marino_de_galapagos', nombre: 'Lobo marino de Galápagos',
            ...
            acercaDe: 'En general, los lobos marinos son especies gregarias y adaptadas a ecosistemas costeros, atributos que las ubican como piezas importantes dentro de la dinámica del ecosistema. Se ha comprobado que esta especie tiene la capacidad de responder rápida y claramente a perturbaciones ambientales.[1]\n' + '\n' +
                'Algunos estudios señalan que se alimentan principalmente de peces, sobre todo, de especies pelágicas que tienden a formar grandes cardúmenes cerca de la costa. Complementan su dieta con peces demersales de mayor tamaño que viven en fondos rocosos.[1]\n' + '\n' +
                'Habitan en playas arenosas y sitios protegidos de depredadores, formando pequeñas colonias. Su territorio comprende una parte acuática, que utilizan con fines de termorregulación, y una terrestre, que destinan al descanso.[1]\n' + '\n' +
                'Ambos sexos alcanzan la madurez sexual entre los cuatro y seis años, mientras que la madurez física se presenta entre los ocho y nueve años. La longevidad es de 20 a 22 años en las hembras y de 17 años en los machos.[1]\n' + '\n' +
                'Actualmente, no se conoce exactamente su estado poblacional; sin embargo, se estima que existen alrededor de 14 000 individuos distribuidos en aproximadamente 40 colonias ubicadas en la mayoría de las islas del archipiélago.[1]\n',
            ...
            referencias: '[1] Diego Páez-Rosas. “Lobo marino de Galápagos o lobo marino común”. Fundación Charles Darwin (FCD) y WWF-Ecuador. (2018). Atlas de Galápagos, Ecuador: Especies Nativas e Invasoras. Quito, FCD y WWF-Ecuador: 153.\n'  +
                '[2] Charles Darwin Foundation: https://www.darwinfoundation.org/en/datazone/checklist?species=5253\n' + '\n' + 'Fotografías: Tui de Roi, recuperado de Minden Pictures.',
            urlSafe: [],
            isMindenPictures: true,
        },
        ...
        {id: 'Flamencos_de_galapagos', nombre: 'Flamencos de Galápagos',
            ...
            referencias: '[1] Kiddle encyclopedia: https://kids.kiddle.co/American_flamingo\n ' +
                ...
                '[3] Charles Darwin Foundation: https://www.darwinfoundation.org/en/datazone/checklist?species=5253\n' + '\n' + 'Fotografías: Tui de Roi, recuperado de Minden Pictures.',
            urlSafe: [],
            isMindenPictures: true,
        },
        ...
        {id: 'Iguana_marina_de_Galapagos', nombre: 'Iguana Marina de Galápagos',
            ...
            acercaDe: 'La iguana marina es el único lagarto moderno que se asocia directamente al medio ambiente marino. Se encuentra distribuida en todo el archipiélago. Su estado de conservación es vulnerable debido a varias amenazas, como la interacción de especies introducidas, alteraciones antropogénicas en su hábitat natural y su sensibilidad frente al cambio climático.[1]\n' + '\n' +
                'En la actualidad, hay poco conocimiento sobre el estado poblacional a nivel subespecífico. Sin embargo, su taxonomía fue revisada recientemente y presenta 11 subespecies, las cuales deben considerarse como unidades de manejo independiente.[1]\n' + '\n' +
                'Generalmente, la iguana marina es considerada una Especie Centinela porque es indicadora de la variación de las condiciones climáticas. Cuando la temperatura de la superficie del mar experimenta un cambio, usualmente común durante la ocurrencia de El Niño-Oscilación Sur (ENOS) en Galápagos, existen grandes fluctuaciones en el tamaño de sus poblaciones.[1]\n' + '\n' +
                'Es herbívora; se alimenta casi exclusivamente de algas macrófitas de la zona intermareal cuando bucea. Por tanto, la disponibilidad de algas es un factor limitante que afecta su crecimiento, tamaño y supervivencia. Asimismo, es muy sensible a la contaminación ambiental y al envenenamiento.[1]\n',
            ...
            referencias: '[1] Alejandro Ibáñez, Sebastian Steinfartz y Gustavo Jiménez-Uzcátegui. “Iguana Marina godzilla”. Fundación Charles Darwin (FCD) y WWF-Ecuador. (2018). Atlas de Galápagos, Ecuador: Especies Nativas e Invasoras. Quito, FCD y WWF-Ecuador: 103-105.\n' + '[2]Charles Darwin Foundation: https://www.darwinfoundation.org/en/datazone/checklist?species=5258\n' + '\n' +
                'Fotografías: Tui de Roi, recuperado de Minden Pictures.',
            urlSafe: [],
            isMindenPictures: true,
        },
        ...
        {id: 'Murcielago_rojo', nombre: 'Murciélago rojo',
            ...
            acercaDe: 'El murciélago rojo está presente en las zonas altas y costeras de Santa Cruz y San Cristóbal. En las regiones costeras de Santa Cruz, durante la temporada de garúa, las hembras usan pequeñas áreas de alimentación (10-20 ha), forrajean solas y dentro del follaje de una variedad de árboles y arbustos, incluyendo manglares. Es abundante en las áreas pobladas, donde se observa frecuentemente alimentándose alrededor del alumbrado público. [1]\n' + '\n' +
                'Los murciélagos rojos son importantes porque contribuyen a los servicios ecosistémicos, como al control de plagas ya que consumen insectos dañinos para los cultivos.[1]\n' + '\n' +
                'Utilizan los manglares rojos, árboles y arbustos en áreas costeras como sitio de reposo. El uso de las pequeñas áreas de forrajeo que rodean dichas áreas sugiere que los murciélagos rojos están en riesgo debido al desarrollo costero en Galápagos.[1]\n' + '\n' +
                'Los modelos generados para estimar la supervivencia del murciélago a largo plazo en América del Norte sugieren que el desarrollo de la energía eólica es una amenaza para sus poblaciones. Sin embargo, estudios previos a la colocación de los parques eólicos, mostraron que sus impactos son mínimos.[1]\n',
            ...
            referencias: '[1] Gary F. McCracken y Gustavo Jiménez-Uzcátegui. “Murciélago rojo de Galápagos”. Fundación Charles Darwin (FCD) y WWF-Ecuador. (2018). Atlas de Galápagos, Ecuador: Especies Nativas e Invasoras. Quito, FCD y WWF-Ecuador: 147.\n' +
                '[2] Charles Darwin Foundation: https://www.darwinfoundation.org/en/datazone/checklist?species=5220\n' + '\n' +
                'Fotografías: Quasarex, recuperado de Quasarex;  jh1792 & Reuven Martin, recuperado de inaturalist.',
            urlSafe: [],
        ...
        {id: 'Tiburon_martillo', nombre: 'Tiburón martillo',
            ...
            referencias: '[1] Pelayo Salinas-de-León y David Acuña-Marrero. “Tiburón martillo”. Fundación Charles Darwin (FCD) y WWF-Ecuador. (2018). Atlas de Galápagos, Ecuador: Especies Nativas e Invasoras. Quito, FCD y WWF-Ecuador: 97.\n' +
                '[2] Charles Darwin Foundation: https://www.darwinfoundation.org/en/datazone/checklist?species=7847\n' + '\n' +
                'Fotografías: Fred Bavendam & Tui de Roi, recuperado de Minden Pictures.',
            urlSafe: [],
            isMindenPictures: true,
        },
        // LANGOSTA ROJA
        ...
        {id: 'Langosta', nombre: 'Langosta roja',
            ...
            referencias: '[1] Jorge Ramírez y Harry Reyes. “Langosta roja”. Fundación Charles Darwin (FCD) y WWF-Ecuador. (2018). Atlas de Galápagos, Ecuador: Especies Nativas e Invasoras. Quito, FCD y WWF-Ecuador: 87.\n' +
                '[2] Charles Darwin Foundation: https://www.darwinfoundation.org/en/datazone/checklist?species=7962\n' + '\n' +
                'Fotografías: Jessee J. Smith, pinesnake & pgkaestner, recuperado de inaturalist.',
            urlSafe: [],
            isMindenPictures: false,
        }
    ];
